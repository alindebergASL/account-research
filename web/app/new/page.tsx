  ...
  return (
    <main className="min-h-screen flex items-start justify-center px-6 py-12">
      <div className="w-full max-w-2xl">
        ...
        >
          <ArrowLeft className="size-4" /> Briefs
        </Link>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <div className="inline-flex items-center gap-2 mb-3 text-xs uppercase tracking-widest text-muted">
...
const MODE_HINT: Record<"quick" | "standard" | "deep", string> = {
  quick:
    "Fast snapshot — Sonnet, single pass, web search only. Good for low-stakes accounts.",
  standard:
    "Balanced depth — Opus + Haiku scout, web search + fetch. Default.",
