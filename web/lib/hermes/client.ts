...
function fakeResearch(req: HermesResearchRequest): HermesResearchResponse {
  ...
  return {
    brief: {
      ...
      recent_signals: [],
      ai_tech_maturity: { rating: 0, rationale: "[fake]" },
      top_initiatives: [],
      technical_footprint: {
        ai_in_production: [],
        active_pilots: [],
      ...
      programs_procurement: {
        ...
        risk_compliance_drivers: [],
      },
      stakeholders: [],
      pursuit: {
        recommended_pitch: "[fake]",
        differentiation_vs_incumbents: "[fake]",
        objections_likely: [],
        opening_meeting_objectives: [],
      },
      open_questions: [],
      sources: [],
    } as unknown as HermesResearchResponse["brief"],
