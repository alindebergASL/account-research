// CommonJS mirror of password.ts so the standalone admin CLI can run without TS.
// Keep in sync with password.ts when changing parameters.
...
module.exports = { hashPassword, verifyPassword, randomTempPassword };
